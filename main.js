    ...
    facebook.listener = api.listen(async function callback(err, message) {
      try {
        if (typeof message != "undefined" && message != null) {
          ...
          //fbGlobalBanTrigger(message.threadID); SORRY LAM SENPAI
...
//nulled metric code.
// SORRY LAM SENPAI ALOT, I DIDN'T MEAN TO DO THIS WAY ;-; THANKS FOR TEACHING ME AND MADE ME AN ADMIN OF C3C TODAY. THANKS